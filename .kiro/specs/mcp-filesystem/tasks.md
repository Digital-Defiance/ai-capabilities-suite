...
- [x] 4. Implement directory watching

  - [x] 4.1 Create DirectoryWatcher class
  ...
  - [x] 4.2 Implement event handling
  ...
  - [x] 4.3 Implement event filtering
  ...
  - [x] 4.4 Write property test for event detection

    - **Property 3: Directory watching event detection**
    - **Validates: Requirements 2.1**

  - [x] 4.5 Write property test for event filtering
    - **Property 4: Event filtering accuracy**
    - **Validates: Requirements 2.4**

- [x] 5. Implement file search and indexing

  - [x] 5.1 Create FileIndexer class
  ...
  - [x] 5.2 Implement search operations
  ...
  - [x] 5.3 Implement index maintenance
  ...
  - [x] 5.4 Write property test for search completeness

    - **Property 5: File search completeness**
    - **Validates: Requirements 3.1**

  - [x] 5.5 Write property test for indexed search performance

    - **Property 6: Indexed search performance**
    - **Validates: Requirements 3.5**

  - [x] 5.6 Write property test for index updates
    - **Property 7: Index update on file changes**
    - **Validates: Requirements 4.3**

- [x] 6. Implement symlink operations

  - [x] 6.1 Implement symlink creation
  ...
  - [x] 6.2 Implement symlink resolution
  ...
  - [x] 6.3 Implement hard link creation

    - Create hard links
    - Validate source files exist
    - _Requirements: 6.2_

  - [x] 6.4 Write property test for symlink creation

    - **Property 8: Symlink creation correctness**
    - **Validates: Requirements 6.1**

  - [x] 6.5 Write property test for symlink target validation
    - **Property 9: Symlink target validation**
    - **Validates: Requirements 6.4**

- [x] 7. Implement checksum operations

  - [x] 7.1 Create ChecksumManager class
  ...
  - [x] 7.3 Implement batch checksum computation

    - Compute checksums for multiple files
    - Return results for each file
    - _Requirements: 7.3_

  - [x] 7.4 Write property test for checksum accuracy
...
- [x] 8. Implement disk usage analysis

  - [x] 8.1 Create DiskUsageAnalyzer class
  ...
  - [x] 8.2 Implement size calculation
  ...
  - [x] 8.3 Implement usage reporting
    - Generate size reports
    - Group by file type
    - Sort by size
    - _Requirements: 8.2, 8.4_

- [x] 9. Implement directory operations

  - [x] 9.1 Implement directory copy
  ...
  - [x] 9.2 Implement directory sync
  ...
  - [x] 9.3 Implement atomic file replacement
  ...
  - [x] 9.4 Write property test for recursive copy

    - **Property 15: Recursive copy completeness**
    - **Validates: Requirements 10.1**

  - [x] 9.5 Write property test for sync efficiency

    - **Property 16: Sync operation efficiency**
    - **Validates: Requirements 10.2**

  - [x] 9.6 Write property test for atomic replacement
    - **Property 14: Atomic file replacement**
    - **Validates: Requirements 9.5**

- [x] 10. Implement MCP tools

  - [x] 10.1 Implement fs_batch_operations tool
  ...
  - [x] 10.2 Implement fs_watch_directory tool
  ...
  - [x] 10.3 Implement fs_get_watch_events tool
  ...
  - [x] 10.4 Implement fs_stop_watch tool
  ...
  - [x] 10.5 Implement fs_search_files tool
  ...
  - [x] 10.6 Implement fs_build_index tool
  ...
  - [x] 10.7 Implement fs_create_symlink tool
  ...
  - [x] 10.8 Implement fs_compute_checksum tool
  ...
  - [x] 10.9 Implement fs_verify_checksum tool
  ...
  - [x] 10.10 Implement fs_analyze_disk_usage tool
  ...
  - [x] 10.11 Implement fs_copy_directory tool
  ...
  - [x] 10.12 Implement fs_sync_directory tool
  ...
  - [x] 10.13 Write property test for response structure
...
- [x] 11. Set up MCP server
  ...
  - [x] 11.1 Create MCP server instance
    ...
    - Ensure MCP config is registered https://code.visualstudio.com/updates/v1_105#_mcp-specification-updates
      - See other vscode extensions we've developed (vscode-mcp-acs-process, vscode-mcp-debugger, vscode-mcp-screenshot) in their extensions.ts and package.json
    - _Requirements: 12.1_
  ...
  - [x] 11.4 Load security configuration
...
- [x] 13. Write integration tests
  ...
  - [x] 13.1 Test batch operations workflow
  ...
  - [x] 13.2 Test directory watching workflow
  ...
  - [x] 13.3 Test search and indexing workflow
...
- [x] 15. Create VS Code Language Server Extension for LSP/MCP Integration
...
- [x] 16. Create documentation
  ...
  - [x] 16.1 Write README documentation
  ...
  - [x] 16.2 Create security configuration guide
  ...
  - [x] 16.3 Add code documentation
    - Add JSDoc comments to all public APIs
    - Document security validation layers
    - Document error codes and meanings
    - _Requirements: 12.2_

- [x] 17. Implement Language Model Tools / Language Client. Investigate and implement any other extension features that are relevant and available to implement.

- [x] 18. Copy github workflows from other MCPs we've done (mcp-process -> mcp-filesystem, vscode-mcp-acs-process -> vscode-mcp-acs-filesystem)

- [x] 19. Set up sync-versions.ts for mcp-filesystem & vscode-mcp-acs-filesystem

- [x] 20. Duplicate/mimic package.json and extension.ts MCP functionality from mcp-debugger/mcp-process/mcp-screenshot which registers with CoPilot

- [x] 21. Integrate with the vscode-shared-status-bar-icon library following the model set forth by the other extensions. Feel free to copy from them. It should add relevant status bar actions.

- [-] 22. Package and distribute

  - [x] 22.1 Publish to NPM registry
