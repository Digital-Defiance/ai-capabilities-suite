...
This document outlines the test plan for verifying the MCP ACS Debugger extension works correctly with VS Code and GitHub Copilot.
...
- MCP ACS Debugger extension installed and compiled
...
3. Check the Output panel (View → Output → MCP ACS Debugger)

**Expected Results**:

- ✅ Extension activates without errors
- ✅ "MCP ACS Debugger extension activating..." message appears
- ✅ "MCP ACS Debugger extension activated" message appears
...
- ✅ "MCP ACS Debugger server started successfully" message appears
...
2. Type "MCP ACS Debugger"

**Expected Results**:

- ✅ "MCP ACS Debugger: Start Debug Session" appears
- ✅ "MCP ACS Debugger: Detect Hanging Process" appears
- ✅ "MCP ACS Debugger: Set Smart Breakpoint" appears
- ✅ "MCP ACS Debugger: Start CPU Profiling" appears
- ✅ "MCP ACS Debugger: Take Heap Snapshot" appears
...
2. Run command: "MCP ACS Debugger: Start Debug Session"
...
2. Run command: "MCP ACS Debugger: Detect Hanging Process"
