# MCP ACS Debugger Server v--from=v1.0.0
...
```bash
wget https://github.com/digital-defiance/ai-capabilities-suite/releases/download/v--from=v1.0.0/ts-mcp-server-linux-x64.tar.gz
...
```bash
wget https://github.com/digital-defiance/ai-capabilities-suite/releases/download/v--from=v1.0.0/ts-mcp-server-macos-x64.tar.gz
...
```powershell
Invoke-WebRequest -Uri https://github.com/digital-defiance/ai-capabilities-suite/releases/download/v--from=v1.0.0/ts-mcp-server-win-x64.zip -OutFile ts-mcp-server.zip
...
**Full Changelog**: <https://github.com/digital-defiance/ai-capabilities-suite/compare/v--to=v1.1.0...v--from=v1.0.0>
